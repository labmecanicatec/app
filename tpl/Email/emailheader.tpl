...
<body
	...
	<div dir="ltr" class="es-wrapper-color" lang="es" style="background-color:#F6F6F6">
		...
		<![endif]-->
		<table class="es-wrapper" cellspacing="0" cellpadding="0" width="100%" role="none"
						...
						<tr>
							<td class="es-adaptive" align="center" style="padding:0;Margin:0">
								<table class="es-header-body" cellspacing="0" cellpadding="0" align="center" role="none"
									...
									<tr>
										<td style="padding:15px;Margin:0;background-color:#192129;" bgcolor="#192129"
											align="left">
						...
						<tr>
							<td class="es-adaptive" align="center" style="padding:0;Margin:0">
								<table class="es-header-body" cellspacing="0" cellpadding="0" align="center" role="none"
									style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:600px">
									<tr>
										<td style="padding:15px;Margin:0;background-color:#ffffff;" bgcolor="#ffffff"
											align="left">
											<!--[if mso]><table style="width:570px" cellpadding="0" cellspacing="0"><tr><td style="width:137px" valign="top"><![endif]-->
											<table class="es-left" cellspacing="0" cellpadding="0" align="left"
												role="none"
												style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
												<tr>
													<td class="es-m-p0r es-m-p20b" valign="top" align="center"
														style="padding:0;Margin:0;width:137px">
																...
																<td align="left"
																	style="padding:0;Margin:0;font-size:0px"><a
																		...
																		style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#1376C8;font-size:14px"><img
																			src="https://fkpnytl.stripocdn.email/content/guids/CABINET_490bcb2a5149a0952d2f438e39b6cb5a2955cdc450222a98dc7fa58a5b1caae0/images/bannerudmecanica.png"
																			alt="Enlace Universidad Distrital"
																			width="108"
																			title="Enlace Universidad Distrital"
											...
											<!--[if mso]></td><td style="width:433px" valign="top"><![endif]-->
											<table cellspacing="0" cellpadding="0" align="right" role="none"
												style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
												<tr>
													<td align="left" style="padding:0;Margin:0;width:433px">
														<table cellspacing="0" cellpadding="0" width="100%"
															role="presentation"
															style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
															<tr>
																<td align="left" class="h-auto" valign="middle"
																	height="45" style="padding:0;Margin:0">
																	<p
						...
						<tr>
							<td class="es-adaptive" align="center" style="padding:0;Margin:0">
								<table class="es-header-body" cellspacing="0" cellpadding="0" align="center" role="none"
									style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:600px">
									<tr>
										<td style="padding:15px;Margin:0;background-color:#8c1919;" bgcolor="#8c1919"
											align="left">
											<!--[if mso]><table style="width:570px" cellpadding="0" cellspacing="0"><tr><td style="width:180px" valign="top"><![endif]-->
											<table class="es-left" cellspacing="0" cellpadding="0" align="left"
												role="none"
														...
														<table cellspacing="0" cellpadding="0" width="100%"
															...
															<tr>
																<td class="es-m-txt-c" align="left"
																	...
																	<p
style="Margin:0;line-height:28.8px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#333333">