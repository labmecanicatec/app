	...
	<tr>
		<td align="center" style="padding:0;Margin:0">
			<table class="es-content-body"
				style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#31cb4b;width:600px"
				cellspacing="0" cellpadding="0" bgcolor="#31cb4b" align="center" role="none">
				<tr>
					<td style="Margin:0;padding-left:5px;padding-right:5px;padding-top:10px;padding-bottom:10px;background-color:#192129"
						bgcolor="#192129" align="left">
										...
										<tr>
											<td align="center" style="padding:20px;Margin:0;font-size:0">
												<table border="0" width="100%" height="100%" cellpadding="0"
													...
													<tr>
														<td
															style="padding:0;Margin:0;border-bottom:1px solid #cccccc;background:unset;height:0px;width:100%;margin:0px">
														</td>
													</tr>
												</table>
											</td>
										...
										<tr>
											<td align="center" style="padding:0;Margin:0;padding-top:5px">
												<p
													...
													©&nbsp;2026 | Laboratorios y Talleres de Mecánica | Facultad
													Tecnológica</p>
											</td>
										</tr>
									</table>
